...
def perfil(user, selected_username):
    ...
    if opt_layout == 'meu_perfil': print(f'\n\033[1;94mID:\033[0m {user['id']}    \033[1;94mNome de usuário:\033[0m {user['nome']}    \033[1;94mE-mail:\033[0m {user['email']}    \033[1;94mPerfil criado em:\033[0m {user['criacao']}')
    else: print(f'\n\033[1;94mID:\033[0m {user['id']}    \033[1;94mNome de usuário:\033[0m {user['nome']}    \033[1;94mPerfil criado em:\033[0m {user['criacao']}')
...
def verPerfil(curr_user, user = ''):
    if user == '':
        ...
        for i in range(len(users)):
            if users[i]['id'] == user: user = users[i]['nome']
    
    return perfil(curr_user, user)
